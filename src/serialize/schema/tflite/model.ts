...
import { Buffer } from '../tflite/buffer';
import { ExternalBuffer } from '../tflite/external-buffer';
import { ExternalBufferGroup } from '../tflite/external-buffer-group';
import { Metadata } from '../tflite/metadata';
import { OperatorCode } from '../tflite/operator-code';
import { SignatureDef } from '../tflite/signature-def';
import { SubGraph } from '../tflite/sub-graph';
...
externalBufferGroups(index: number, obj?:ExternalBufferGroup):ExternalBufferGroup|null {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? (obj || new ExternalBufferGroup()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}

externalBufferGroupsLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}

externalBuffers(index: number, obj?:ExternalBuffer):ExternalBuffer|null {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? (obj || new ExternalBuffer()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}

externalBuffersLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
...
static addExternalBufferGroups(builder:flatbuffers.Builder, externalBufferGroupsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(8, externalBufferGroupsOffset, 0);
}

static createExternalBufferGroupsVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startExternalBufferGroupsVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}

static addExternalBuffers(builder:flatbuffers.Builder, externalBuffersOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, externalBuffersOffset, 0);
}

static createExternalBuffersVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startExternalBuffersVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}
...
static createModel(builder:flatbuffers.Builder, version:number, operatorCodesOffset:flatbuffers.Offset, subgraphsOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, buffersOffset:flatbuffers.Offset, metadataBufferOffset:flatbuffers.Offset, metadataOffset:flatbuffers.Offset, signatureDefsOffset:flatbuffers.Offset, externalBufferGroupsOffset:flatbuffers.Offset, externalBuffersOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  Model.addExternalBufferGroups(builder, externalBufferGroupsOffset);
  Model.addExternalBuffers(builder, externalBuffersOffset);
