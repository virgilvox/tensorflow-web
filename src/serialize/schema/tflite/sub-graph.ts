...
import { Operator } from '../tflite/operator';
import { Tensor } from '../tflite/tensor';
...
static addDebugMetadataIndex(builder:flatbuffers.Builder, debugMetadataIndex:number) {
  builder.addFieldInt32(5, debugMetadataIndex, -1);
}
...
static createSubGraph(builder:flatbuffers.Builder, tensorsOffset:flatbuffers.Offset, inputsOffset:flatbuffers.Offset, outputsOffset:flatbuffers.Offset, operatorsOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, debugMetadataIndex:number):flatbuffers.Offset {
  ...
  SubGraph.addDebugMetadataIndex(builder, debugMetadataIndex);
