...
const props = withDefaults(
  defineProps<{
    /**
     * Height of the stripe bar in pixels. Defaults to 14 to read as a
     * thin rail rather than a block of fill.
     */
    height?: number
  }>(),
  {
...
<template>
  <div class="hazbar" :style="{ height: `${props.height}px` }" aria-hidden="true" />
</template>
